...
function total(){
    var prices=document.getElementsByName("bPrice");
    var count=document.getElementsByName("sNumber");
    var sum=0;
    for(var i=0; i<prices.length;i++){
       sum+=prices[i].value*count[i].value;
    }
    document.getElementById("totalPrice").getElementsByTagName("span").innerHTML=sum.toFixed(2);
}
total();