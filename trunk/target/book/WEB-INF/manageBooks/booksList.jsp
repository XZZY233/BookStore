                ...
                toolbar: [{
                    ...
                    handler: function(){
                        parent.$('#win').window({
                            ...
                            height:500,
                            modal:true,
                            content:"<iframe src='<%=bathPath%>/books/booksAdd' height='100%' width='100%' frameborder='0px' ></iframe>"
                        });
                    }
                },'-',{
                    iconCls: 'icon-edit',
                    ...
                    handler: function(){
                        ...
                        parent.$('#win').window({
                            ...
                            height:500,
                            modal:true,
                            content:"<iframe src='<%=bathPath%>/books/booksUpdate' height='100%' width='100%' frameborder='0px' ></iframe>"
                        });
                    }
                },'-',{
                    iconCls: 'icon-remove',
